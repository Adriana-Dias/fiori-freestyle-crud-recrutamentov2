		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Recrutamento",
									"targetURL": "#v2recrutamentov2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"v2recrutamentov2-display": {
								"semanticObject": "v2recrutamentov2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=v2.recrutamentov2",
									"url": sap.ui.require.toUrl("v2/recrutamentov2")
								}
							}
						}
					}
